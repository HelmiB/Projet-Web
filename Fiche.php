...
<div class="row" >
    ...
    <div class="col-md-10 contenu">
        ...
        <div class="panel panel-info contentinside">
            <!----------------   Panel Head   --------------->
            <div class="panel-heading"><strong>Dossier médical n° <?php echo $_GET['id']; ?></strong></div>
            <!----------------   Panel Body Start   --------------->
                ...
                <div class="row" >
                    ...
                    <section class="col-sm-4 table-responsive">
                        <table class="table table-bordered table-striped table-condensed">
                            ...
                            <?php if($donnee['date_sortie']!= '0000-00-00'){?>
            ...
            <div class="panel-heading"><strong>Gestion des visites</strong></div>
            <div class="panel-body" id="visite">
                <div>
                    <form class="navbar-form pull-right">
                        <a  href="formVisite.php?id=<?php echo $id_patient ?>&dep=<?php echo $donnee['departement']?>" class="btn btn-primary">
                            <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>Ajouter Visite
                        </a>
                    </form>
                </div>
                <!----------------   Affichage Visites commence ici   --------------->
                <div>
